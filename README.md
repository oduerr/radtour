...
- Profile follows the map (⚙ „Profil folgt Karte“, default on): the profile shows only the part of the stage inside the visible map, min. 2 km; window length as „Ausschnitt x km“. Off = whole stage.
