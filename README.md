...
- Profile follows the map (⚙ „Profil folgt Karte“, default on): a selected day shows the whole stage; once you pan or zoom, the profile shows the part of the route inside the visible map, also across days (min. 2 km), with the length as „Ausschnitt x km“. Off = whole stage.
