...
bundle={'track':load('track.json',[]),'stages':load('stages.json',[]),'places':load('places.json',[]),'features':load('features.json',[]),'weather':load('weather.json',[]),'variants':load('variants.json',[])}
